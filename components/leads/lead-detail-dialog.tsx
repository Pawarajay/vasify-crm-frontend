...
//   const canConvert = lead.status === "closed-won"
...
//                     Only leads with status <span className="font-medium">Closed Won</span> can be
...
//     // Only update status, do not send dates from here
...
//                         </SelectContent>
//                       </Select>
//                       <Badge className={getStatusBadge(statusValue)}>
//                         {statusValue.replace("-", " ")}
//                       </Badge>
//                     </div>
//                   </div>
...
//                 {!canConvert && (
//                   <p className="text-[11px] text-muted-foreground mt-1">
//                     Change status to <span className="font-medium">Closed Won</span> above to
...
//testing for responsive page(22-12-2025)
"use client"
