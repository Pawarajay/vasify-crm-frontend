...
//           </DialogTitle>
//           <DialogDescription>
//             Convert "{lead.name}" from a lead to a customer. This will create a new customer record and remove the lead.
//           </DialogDescription>
//         </DialogHeader>
...
//               </div>
//               <div>
//                 <span className="text-muted-foreground">Estimated Value:</span> ${lead.estimatedValue.toLocaleString()}
//               </div>
//             </div>
//           </div>
