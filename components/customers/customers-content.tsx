...
// //   const handleBackToLead = (e: React.MouseEvent, customer: Customer) => {
// //     e.preventDefault()
// //     e.stopPropagation()

// //     if (!("leadId" in customer) || !(customer as any).leadId) {
// //       alert("No lead linked to this customer.")
// //       return
// //     }

// //     const leadId = (customer as any).leadId as string
...
// export function CustomersContent() {
//   // NOTE: use moveCustomerToLead – this matches crm-context
...
//       }
//       // state will refresh from context
//     } catch (error) {
...
//testing for adding new changes (19-12-2025)
