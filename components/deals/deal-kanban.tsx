...
// import { MoreHorizontal, Edit, Eye, Trash2, DollarSign, Calendar, User } from "lucide-react"
...
//                                 <DropdownMenuItem
//                                   key={s.id}
//                                   onClick={() => handleStageChange(deal.id, s.id as Deal["stage"])}
...
//                               <div className="bg-primary h-1 rounded-full" style={{ width: `${deal.probability}%` }} />
//                             </div>
...
//                 })}
//                 {stageDeals.length === 0 && (
//                   <div className="text-center py-8 text-muted-foreground text-sm">No deals in this stage</div>
//                 )}
//               </CardContent>
//             </Card>
//           </div>
