...
// import { Plus, Search, BarChart3, DollarSign, TrendingUp, Target } from "lucide-react"
...
//       deal.products.some((product) => product.toLowerCase().includes(searchTerm.toLowerCase()))

//     const matchesCustomer = customerFilter === "all" || deal.customerId === customerFilter
...
//     wonValue: deals.filter((d) => d.stage === "closed-won").reduce((sum, deal) => sum + deal.value, 0),
...
//               <div>
//                 <div className="text-2xl font-bold">${stats.wonValue.toLocaleString()}</div>
...
//           <CardDescription>Manage deals across different stages</CardDescription>
//         </CardHeader>
//         <CardContent>
...
//                 <div className="text-xs text-muted-foreground capitalize">{stage.replace("-", " ")}</div>
//               </div>
//             ))}
//           </div>
...
//                           <td className="p-4">
//                             <div className="flex items-center gap-2">
//                               <Button variant="ghost" size="sm" onClick={() => handleViewDetails(deal)}>
//                                 View
//                               </Button>
...
//       {/* Dialogs */}
//       <DealDialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen} deal={null} mode="add" />

//       <DealDialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen} deal={selectedDeal} mode="edit" />

//       <DealDetailDialog open={isDetailDialogOpen} onOpenChange={setIsDetailDialogOpen} deal={selectedDeal} />
//     </div>
//   )
// }
