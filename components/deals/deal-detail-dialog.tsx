...
// import { User, DollarSign, Calendar, TrendingUp, Package, FileText, Phone, Mail, MessageSquare } from "lucide-react"
...
//   const dealTasks = tasks.filter((task) => task.relatedTo.type === "deal" && task.relatedTo.id === deal.id)
...
//             {deal.title}
//           </DialogTitle>
//           <DialogDescription>Complete deal overview and progress tracking</DialogDescription>
//         </DialogHeader>
...
//                   <div>
//                     <div className="text-sm font-medium text-muted-foreground">Deal Title</div>
...
//                     <div>
//                       <div className="text-sm font-medium text-muted-foreground">Deal Value</div>
...
//                       <div className="text-sm">{deal.expectedCloseDate.toLocaleDateString()}</div>
//                     </div>
//                   </div>
...
//                       <div>
//                         <div className="text-sm font-medium text-muted-foreground">Actual Close</div>
//                         <div className="text-sm">{deal.actualCloseDate.toLocaleDateString()}</div>
//                       </div>
//                     </div>
//                   )}
//                 </div>
...
//                     <div className="text-sm bg-muted p-3 rounded-md">{deal.notes}</div>
//                   </div>
//                 )}
//               </CardContent>
//             </Card>
...
//                 <CardDescription>Track the deal through sales stages</CardDescription>
//               </CardHeader>
//               <CardContent>
//                 <div className="space-y-4">
//                   <div className="flex items-center gap-2 mb-4">
//                     <Progress value={getStageProgress(deal.stage)} className="flex-1" />
//                     <span className="text-sm font-medium">{Math.round(getStageProgress(deal.stage))}%</span>
//                   </div>
...
//                               isActive ? "bg-primary" : isPassed ? "bg-green-500" : "bg-muted"
//                             }`}
//                           />
//                           <span
...
//                   <span className="text-sm">{deal.createdAt.toLocaleDateString()}</span>
//                 </div>

//                 <div className="flex items-center justify-between">
//                   <span className="text-sm text-muted-foreground">Last Updated</span>
//                   <span className="text-sm">{deal.updatedAt.toLocaleDateString()}</span>
//                 </div>

//                 <div className="flex items-center justify-between">
//                   <span className="text-sm text-muted-foreground">Days in Stage</span>
//                   <span className="text-sm">
//                     {Math.ceil((new Date().getTime() - deal.updatedAt.getTime()) / (1000 * 60 * 60 * 24))}
//                   </span>
//                 </div>
//               </CardContent>
//             </Card>
