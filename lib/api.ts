...
//     return apiRequest<{ customers: any[]; pagination: any }>(`/customers${query ? `?${query}` : ""}`)
//   },
...
//     const query = searchParams.toString()
//     return apiRequest<{ leads: any[]; pagination: any }>(`/leads${query ? `?${query}` : ""}`)
//   },
...
//     return apiRequest<{ customer: any; message: string }>(`/leads/${id}/convert`, {
//       method: "POST",
//       body: JSON.stringify({ customerData }),
//     })
//   },
...
//     const query = searchParams.toString()
//     return apiRequest<{ deals: any[]; pagination: any }>(`/deals${query ? `?${query}` : ""}`)
//   },
...
//     return apiRequest<{ pipeline: any[]; closed: any[] }>("/deals/pipeline/summary")
//   },
// }
...
//     const query = searchParams.toString()
//     return apiRequest<{ tasks: any[]; pagination: any }>(`/tasks${query ? `?${query}` : ""}`)
//   },
...
//     const query = searchParams.toString()
//     return apiRequest<{ invoices: any[]; pagination: any }>(`/invoices${query ? `?${query}` : ""}`)
//   },
...
//     const query = searchParams.toString()
//     return apiRequest<{ renewals: any[]; pagination: any }>(`/renewals${query ? `?${query}` : ""}`)
//   },
...
//     return apiRequest<{ reminder: any; message: string }>("/renewals/reminders", {
//       method: "POST",
...
// //       {
// //         method: "POST",
// //         body: JSON.stringify({}), // backend allows empty body
// //       },
// //     );
// //   },
// // };
...
//     {
//       method: "POST",
//       body: JSON.stringify({}), // or you can remove body entirely
//     },
//   );
// },
// };
